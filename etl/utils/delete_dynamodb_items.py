...
def delete_all_items(table_name: str) -> None:
    """
    Delete all items from a specified DynamoDB table.
    This is a tool in case items need to be purged from the database.
...
# Call the function to delete all items in the 'DataNOAA' table
